...
void bmp280_init() {
    ...
    i2c_write_blocking(I2C_PORT, ADDR_BMP, buf, 2, false);
...
void bmp280_read_raw(int32_t* temp, int32_t* pressure) {
    ...
    i2c_write_blocking(I2C_PORT, ADDR_BMP, &reg, 1, true);  // true to keep master control of bus
    i2c_read_blocking(I2C_PORT, ADDR_BMP, buf, 6, false);  // false - finished with bus
...
void bmp280_get_calib_params(struct bmp280_calib_param* params) {
    ...
    i2c_read_blocking(I2C_PORT, ADDR_BMP, buf, NUM_CALIB_PARAMS, false);  // false, we're done reading
